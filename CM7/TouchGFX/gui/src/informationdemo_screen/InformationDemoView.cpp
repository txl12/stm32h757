...
InformationDemoView::InformationDemoView():
    tickCounter(0),
    transitionCounter(0),
...
void InformationDemoView::setupScreen()
{
    readSharedData();

    InformationDemoViewBase::setupScreen();
}

void InformationDemoView::tearDownScreen()
{
    InformationDemoViewBase::tearDownScreen();
...
void InformationDemoView::handleTickEvent()
{
    tickCounter++;
    transitionCounter++;
...
void InformationDemoView::pressCenterKeyFunction()
{
    if (previousScreen == Enums::Cooking)
    {
        goToCookingMenu();
...
void InformationDemoView::updateTimer() // only used if we were in the cooking screen before to keep the timer running
{
...
void InformationDemoView::clockAnimation()
{
    clockCounter++;
...
void InformationDemoView::readSharedData()
{
...
void InformationDemoView::saveSharedData()
{
